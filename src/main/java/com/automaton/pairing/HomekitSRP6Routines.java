...
/**
 * This class is modified from the nimbus SRP library to provide methods that are compatible with some pecularities of
 * Homekit. Namely, the need for a 3072 bit private value
 * 

 ...
 * 
 * Characteristics are the lowest level building block of the Homekit Accessory Protocol. They define variables that can
 * be retrieved or set by the remote client. Most consumers of this library will be better served by using one of the
 * characteristic classes in {@link com.automaton.characteristics} when creating custom accessory types (the standard
 * accessories from {@link com.automaton.accessories} already include the necessary characteristics), instead of
 * trying to implement the JSON formats directly.
 *
 * @author Andy Lintner
 */
